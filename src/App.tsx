        ...
        <section className="flex flex-col gap-4">
          ...
          {denuncias.map((denuncia) => (
            <article
              ...
              <p><span className="font-medium">Denúncia: </span> {denuncia.titulo}</p>
              <p><span className="font-medium">Descrição: </span> {denuncia.descricao}</p>
              <p><span className="font-medium">Localidade: </span> {denuncia.localidade}</p>
